...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("products_total", sa.Numeric(10, 3), nullable=False),
        sa.Column("discount_price", sa.Numeric(10, 3), nullable=False),
        sa.Column("delivery_address", sa.Text(), nullable=True),
        sa.Column("delivery_charge", sa.Numeric(10, 3), nullable=True),
        sa.Column("net_price", sa.Numeric(10, 3), nullable=False),
